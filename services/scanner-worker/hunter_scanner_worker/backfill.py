...
MIN_REQUEST_MINUTES = 5
"""Below this a "gap" is the current minute still being collected."""
...
__all__ = ["BackfillRequester", "MIN_REQUEST_MINUTES"]
...
class BackfillRequester:
    ...
    async def request(
        ...
        *,
        ...
        """Ask for ``[gap_start, gap_end]``. ``False`` = too small, or asked recently."""
        moment = now or utcnow()
        if gap_end - gap_start < timedelta(minutes=MIN_REQUEST_MINUTES):
            return False
