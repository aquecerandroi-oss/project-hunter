...
a realized funding settlement, an open-interest reading and a liquidation each
become a row somewhere downstream, so losing the event loses work nobody can
