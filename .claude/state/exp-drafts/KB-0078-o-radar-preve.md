...
> **RASCUNHO do quant-engineer (T3.46, 2026-09-08)** para a Sexta-feira arquivar em
> `obsidian/11-KNOWLEDGE/`. Não editei `obsidian/**`. Nada foi commitado.
> Proveniência de todo número desta nota: `.claude/state/notes-T3.46.md` (tabelas cruas com
> `read_at`) e os arquivos `infra/scripts/sql/research/2026-09-09-radar-0{1..6}-*.sql`.
> Corte das leituras: **2026-09-08 22:16 → 22:37 UTC** (19:16 → 19:37 de Brasília).
