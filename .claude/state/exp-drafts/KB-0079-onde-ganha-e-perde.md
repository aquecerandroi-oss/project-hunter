...
owner: sexta-feira
updated: 2026-09-09
confiança: "alta no diagnóstico de que quase tudo é ruído e no descarte dos dois artefatos; baixa-média no único achado que sobrou (36 decisões de replay, 8 dias, sem validação prospectiva possível hoje)"
---

# Onde ganhamos e onde perdemos: 2 248 fatias, 86 julgáveis, 1 achado

> **RASCUNHO do quant-engineer (T3.53, 2026-09-09) para a Sexta-feira arquivar em
> `obsidian/11-KNOWLEDGE/`.** Não editei `obsidian/**`. Nada foi commitado. Nada foi escrito na
> VPS. Proveniência de todo número: `.claude/state/notes-T3.53.md` (tabelas cruas com `read_at`) e
...
mesmo dia, em quatro mercados correlacionados, compartilham choque — [[KB-0010]]), e as maiores
...
**A perda ainda é o custo** ([[KB-0076]]). Em 6 de 6 famílias×coortes a faixa de pedágio
