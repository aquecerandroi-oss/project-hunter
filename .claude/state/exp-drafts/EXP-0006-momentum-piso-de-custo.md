...
> **RASCUNHO do quant-engineer (T3.26, 2026-09-08).** Escrito em
> `.claude/state/exp-drafts/` para a Sexta-feira arquivar em
> `obsidian/05-EXPERIMENTS/EXP-0006-momentum-piso-de-custo.md` e ligar a partir de
> [[Strategy Backlog]] (candidata #2), [[KB-0008-custos-em-perpetuos-e-o-r-que-sobra]],
> [[EXP-0001-momentum-v1]] (o pai) e [[Experiments Index]]. Não editei `obsidian/**`.
>
...
> **nunca** muda; as avaliações são **acrescentadas** abaixo, datadas.
...
|---|---|---|---|
| `atr_pct_min = 0,0089` (`momentum v4`) | 2026-09-08 | [[KB-0008-custos-em-perpetuos-e-o-r-que-sobra]], candidata #2 | esta página; `system_events` `strategy_version_variant_derived` |
| invalidação (`INV-B/C/E`) | — | exige código novo (`momentum_v2`), não é parâmetro | `.claude/state/brief-T3.27-momentum-v2-invalidacao.md` |

## Relacionadas

[[Experiments Index]] · [[EXP-0001-momentum-v1]] · [[Strategy Backlog]] ·
