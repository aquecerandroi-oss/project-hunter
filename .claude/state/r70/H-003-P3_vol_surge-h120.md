# H-003 — P3_vol_surge em h = 120 min (lado à vista, universo U2) — NÃO CONFIRMA

> Origem: R68 parte B — h=240 ficou inconclusivo em 5 células (partb_U2.txt 28–32: IC atravessando zero em todas) · KB-0149 §7  ·  impressão digital do pré-registo: `960d79f4af3e`
...
| 2 | selecionados / resto no limiar congelado | 1494 / 8472 |
| 3 | média do desfecho: selecionados / resto | +0.0016 / -0.0009 |
| 4 | **D = média(selecionados) − média(resto)** | **+0.0025** |
| 5 | IC 95 % de D (bootstrap de cluster por `mercado`) | [+0.0016, +0.0034]  P(D≤0) = 0.000 |
| 6 | IC 95 % de D (bootstrap de blocos) | [+0.0001, +0.0040] em 18 blocos |
| 7 | p de permutação (estratificada por `dia`) | 0.1478 |
| 8 | fatia de teste reservada: D | +0.0016 (449/2637; 576 linhas purgadas) |
...
- p de permutação 0.1478 não é < 0,05
...
|---|---|---|---|
| -0 | 8472 | -0.0009 | -0.0014 |
| 0-inf | 1494 | +0.0016 | -0.0002 |
