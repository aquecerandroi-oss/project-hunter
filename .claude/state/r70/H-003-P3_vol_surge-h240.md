# H-003 — P3_vol_surge em h = 240 min (lado à vista, universo U2) — NÃO CONFIRMA

> Origem: R68 parte B — h=240 ficou inconclusivo em 5 células (partb_U2.txt 28–32: IC atravessando zero em todas) · KB-0149 §7  ·  impressão digital do pré-registo: `16e3c2b07032`
...
| 2 | selecionados / resto no limiar congelado | 892 / 3587 |
| 3 | média do desfecho: selecionados / resto | +0.0032 / -0.0003 |
| 4 | **D = média(selecionados) − média(resto)** | **+0.0035** |
| 5 | IC 95 % de D (bootstrap de cluster por `mercado`) | [+0.0024, +0.0046]  P(D≤0) = 0.000 |
| 6 | IC 95 % de D (bootstrap de blocos) | [-0.0001, +0.0058] em 17 blocos |
| 7 | p de permutação (estratificada por `dia`) | 0.5253 |
| 8 | fatia de teste reservada: D | +0.0010 (270/1265; 288 linhas purgadas) |
...
- p de permutação 0.5253 não é < 0,05
- há dependência temporal declarada e o IC 95 % por blocos [-0.0001, +0.0058] cobre zero
...
|---|---|---|---|
| -0 | 3587 | -0.0003 | -0.0014 |
| 0-inf | 892 | +0.0032 | +0.0003 |
