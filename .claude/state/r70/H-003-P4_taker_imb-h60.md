# H-003 — P4_taker_imb em h = 60 min (lado à vista, universo U2) — REFUTA

> Origem: R68 parte B — h=240 ficou inconclusivo em 5 células (partb_U2.txt 28–32: IC atravessando zero em todas) · KB-0149 §7  ·  impressão digital do pré-registo: `7f7dc51c9fac`
...
| 2 | selecionados / resto no limiar congelado | 3199 / 17741 |
| 3 | média do desfecho: selecionados / resto | -0.0011 / -0.0010 |
| 4 | **D = média(selecionados) − média(resto)** | **-0.0001** |
| 5 | IC 95 % de D (bootstrap de cluster por `mercado`) | [-0.0004, +0.0001]  P(D≤0) = 0.812 |
| 6 | IC 95 % de D (bootstrap de blocos) | [-0.0005, +0.0003] em 19 blocos |
| 7 | p de permutação (estratificada por `dia`) | 0.6183 |
| 8 | fatia de teste reservada: D | -0.0003 (700/5488; 1152 linhas purgadas) |
...
|---|---|---|---|
| -0 | 17741 | -0.0010 | -0.0013 |
| 0-inf | 3199 | -0.0011 | -0.0016 |
