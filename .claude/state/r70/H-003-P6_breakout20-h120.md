# H-003 — P6_breakout20 em h = 120 min (lado à vista, universo U2) — NÃO CONFIRMA

> Origem: R68 parte B — h=240 ficou inconclusivo em 5 células (partb_U2.txt 28–32: IC atravessando zero em todas) · KB-0149 §7  ·  impressão digital do pré-registo: `57efd3c8c6ef`
...
| 2 | selecionados / resto no limiar congelado | 537 / 9429 |
| 3 | média do desfecho: selecionados / resto | +0.0002 / -0.0006 |
| 4 | **D = média(selecionados) − média(resto)** | **+0.0008** |
| 5 | IC 95 % de D (bootstrap de cluster por `mercado`) | [-0.0004, +0.0022]  P(D≤0) = 0.114 |
| 6 | IC 95 % de D (bootstrap de blocos) | [-0.0011, +0.0025] em 18 blocos |
| 7 | p de permutação (estratificada por `dia`) | 0.9966 |
| 8 | fatia de teste reservada: D | +0.0002 (171/2915; 576 linhas purgadas) |
...
- IC 95 % inferior -0.0004 não está acima de zero
- p de permutação 0.9966 não é < 0,05
- há dependência temporal declarada e o IC 95 % por blocos [-0.0011, +0.0025] cobre zero
...
|---|---|---|---|
| -0 | 9429 | -0.0006 | -0.0013 |
| 0-inf | 537 | +0.0002 | -0.0017 |
