# H-003 — P4_taker_imb em h = 240 min (lado à vista, universo U2) — NÃO CONFIRMA

> Origem: R68 parte B — h=240 ficou inconclusivo em 5 células (partb_U2.txt 28–32: IC atravessando zero em todas) · KB-0149 §7  ·  impressão digital do pré-registo: `e6e512d8549e`
...
| 2 | selecionados / resto no limiar congelado | 149 / 4330 |
| 3 | média do desfecho: selecionados / resto | +0.0009 / +0.0004 |
| 4 | **D = média(selecionados) − média(resto)** | **+0.0006** |
| 5 | IC 95 % de D (bootstrap de cluster por `mercado`) | [-0.0023, +0.0038]  P(D≤0) = 0.351 |
| 6 | IC 95 % de D (bootstrap de blocos) | [-0.0028, +0.0048] em 17 blocos |
| 7 | p de permutação (estratificada por `dia`) | 0.7730 |
| 8 | fatia de teste reservada: D | +0.0083 (28/1507; 288 linhas purgadas) |
...
- D = +0.0006 abaixo do MRE +0.0010
- IC 95 % inferior -0.0023 não está acima de zero
- p de permutação 0.7730 não é < 0,05
- há dependência temporal declarada e o IC 95 % por blocos [-0.0028, +0.0048] cobre zero
...
|---|---|---|---|
| -0 | 4330 | +0.0004 | -0.0012 |
| 0-inf | 149 | +0.0009 | -0.0017 |
