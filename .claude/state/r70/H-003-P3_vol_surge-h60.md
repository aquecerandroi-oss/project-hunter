# H-003 — P3_vol_surge em h = 60 min (lado à vista, universo U2) — NÃO CONFIRMA

> Origem: R68 parte B — h=240 ficou inconclusivo em 5 células (partb_U2.txt 28–32: IC atravessando zero em todas) · KB-0149 §7  ·  impressão digital do pré-registo: `db8006191df7`
...
| 2 | selecionados / resto no limiar congelado | 2918 / 18022 |
| 3 | média do desfecho: selecionados / resto | -0.0008 / -0.0011 |
| 4 | **D = média(selecionados) − média(resto)** | **+0.0002** |
| 5 | IC 95 % de D (bootstrap de cluster por `mercado`) | [-0.0002, +0.0006]  P(D≤0) = 0.126 |
| 6 | IC 95 % de D (bootstrap de blocos) | [-0.0008, +0.0012] em 19 blocos |
| 7 | p de permutação (estratificada por `dia`) | 0.8184 |
| 8 | fatia de teste reservada: D | +0.0004 (884/5304; 1152 linhas purgadas) |
...
- D = +0.0002 abaixo do MRE +0.0010
- IC 95 % inferior -0.0002 não está acima de zero
- p de permutação 0.8184 não é < 0,05
- o braço selecionado perde em nível (-0.0008); perder menos que o resto não é vantagem
- há dependência temporal declarada e o IC 95 % por blocos [-0.0008, +0.0012] cobre zero
...
|---|---|---|---|
| -0 | 18022 | -0.0011 | -0.0014 |
| 0-inf | 2918 | -0.0008 | -0.0009 |
