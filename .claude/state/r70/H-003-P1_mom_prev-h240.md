# H-003 — P1_mom_prev em h = 240 min (lado à vista, universo U2) — NÃO CONFIRMA

> Origem: R68 parte B — h=240 ficou inconclusivo em 5 células (partb_U2.txt 28–32: IC atravessando zero em todas) · KB-0149 §7  ·  impressão digital do pré-registo: `380bbd914546`
...
| 2 | selecionados / resto no limiar congelado | 2293 / 2186 |
| 3 | média do desfecho: selecionados / resto | +0.0010 / -0.0002 |
| 4 | **D = média(selecionados) − média(resto)** | **+0.0013** |
| 5 | IC 95 % de D (bootstrap de cluster por `mercado`) | [-0.0003, +0.0025]  P(D≤0) = 0.049 |
| 6 | IC 95 % de D (bootstrap de blocos) | [-0.0010, +0.0032] em 17 blocos |
| 7 | p de permutação (estratificada por `dia`) | 0.9660 |
| 8 | fatia de teste reservada: D | +0.0007 (753/782; 288 linhas purgadas) |
...
- IC 95 % inferior -0.0003 não está acima de zero
- p de permutação 0.9660 não é < 0,05
- há dependência temporal declarada e o IC 95 % por blocos [-0.0010, +0.0032] cobre zero
...
|---|---|---|---|
| -0 | 2186 | -0.0002 | -0.0009 |
| 0-1 | 2293 | +0.0010 | -0.0014 |
