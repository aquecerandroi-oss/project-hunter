...
| `EXP-0027` | [[EXP-0027-amplitude\|a amplitude do universo como estado]] (`mean_reversion v18`/`v19` de `v10` — dois braços de **portão de amplitude** sobre a série `breadth_v2`, nenhum parâmetro muda) | T3.89 | **pré-registrado em 2026-09-11 às 09:52 BRT, antes de derivar qualquer variante**; distribuição medida somente-leitura (128 347 linhas usáveis, **cobertura 100 % nos 90 dias**, mediana 0,50, forma em **U**): braço A `[0,10; 0,60)` fica com **46,99 %** dos 8 448 fechamentos de 15 min e braço B `[0,60; 1,00]` com **39,02 %**, `breadth_unavailable` em **0,00 %**. Previsão 1 do rascunho **falsificada na medição** (11,71 % dos minutos acima de 0,90 contra "< 2 %" previstos — 16 mercados são 17 degraus). Tercis congelados em jun–jul: `t1` 0,25 / `t2` 0,6875 |
...
| [[EXP-0027-amplitude]] | `mean_reversion` v18 (A, `breadth=0.10-0.60@breadth_v2`) + v19 (B, falseamento, `breadth=0.60-1.00@breadth_v2`) — **portão de amplitude**, parâmetros do pai `v10` byte a byte | 2026-09-11 | pré-registro arquivado 09:52 BRT; coortes por braço registradas na página | **pré-registrado, replay em andamento** — a distribuição medida antes de derivar dá A 46,99 % e B 39,02 % dos 8 448 fechamentos de 15 min, `breadth_unavailable` 0,00 %, tercis congelados `t1` 0,25 / `t2` 0,6875. Régua congelada igual à da EXP-0026/0028 (Δ condicional × incondicional ≥ +0,05 R com IC de blocos de dia acima de zero **E** n ≥ 100 e ≥ 30 dias **E** positivo em ≥ 2 de 3 janelas **E** LOMO nunca negativo **E** Δ pareado por (mercado, barra) dentro de ±0,02 R) |
