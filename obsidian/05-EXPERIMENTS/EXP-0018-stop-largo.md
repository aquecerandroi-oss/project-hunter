...
> **Arquivado pela Sexta-feira em 2026-09-08 (T3.47)** a partir do rascunho do `quant-engineer`
> (`.claude/state/exp-drafts/EXP-0018-stop-largo.md`, T3.47). "Hipótese", "Braços", "Portão" e
> "Protocolo" vêm do rascunho **sem alteração de conteúdo** e são as seções **congeladas**;
> avaliações são **acrescentadas** abaixo, datadas — a avaliação de dia um (replay retrospectivo,
> T3.47) já está incluída, e as seis coortes `prospective` foram abertas no mesmo instante
> (2026-09-08T22:29–22:38Z).
>
> **A frase honesta que este EXP deixa, verbatim:** o pedágio caiu pelo fator pedido nos seis
> braços (÷1,48 a ÷2,08), mas **os seis intervalos de confiança contêm zero** — só **12 %** da
> economia de pedágio sobrevive no braço `momentum v8` (o único com população julgável em 30 dias);
> com `risk_per_trade_pct` fixo, dobrar o stop **corta a posição pela metade**, então o resultado é
> quase indistinguível de operar menor — **uma alavanca de variância, não de sinal**. Ligada a
> partir de [[Strategy Backlog]], [[Experiments Index]], [[EXP-0007-momentum-invalidacao-bracos-INV]],
> [[EXP-0013-momentum-alvo-3-atr]] e [[KB-0076-por-que-perdemos-2026-09-08]].
...
A identidade do pedágio ([[KB-0076-por-que-perdemos-2026-09-08]], com a correção da notes-T3.40 §8b) diz que
...
`docs/plans/SHADOW-LAB.md` §9 não deixa concluir por replay.
...
ainda não arquivados no vault), alvo mais longe ([[EXP-0013-momentum-alvo-3-atr]]) e stop mais largo (este) terão sido medidos, os três mexendo no
pedágio e nenhum fabricando vantagem — e a conclusão volta a ser a da [[KB-0076-por-que-perdemos-2026-09-08]] item 10:
