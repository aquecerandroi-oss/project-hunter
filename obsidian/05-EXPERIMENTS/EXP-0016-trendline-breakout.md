...
> **Arquivado pela Sexta-feira em 2026-09-08 (T3.34c/T3.41)** a partir do rascunho do
> `quant-engineer` (`.claude/state/exp-drafts/EXP-0016-trendline-breakout.md`, T3.34b/T3.34c).
> "Hipótese", "Portão" e "Protocolo" vêm do rascunho **sem alteração de conteúdo** e são as seções
> **congeladas**; avaliações são **acrescentadas** abaixo, datadas — a avaliação de dia um (T3.34c)
> já está incluída.
>
> **Estado:** `trendline_breakout v1` ativada como `research_only` em
> **2026-09-08T22:29:52,701952Z** (19:29:52 BRT) e replayada 31 dias × 4 mercados
> (coorte `replay:d78c14d1-b4c5-424a-8f31-a43100744bb4`, 11 904 barras, 0 erros). **Veredito do
> funil: `manter em pesquisa`, com a hipótese REENUNCIADA** — no dado real esta versão **não é**
> "rompimento de linha de tendência": é **repique em suporte ascendente** (89,4 % das decisões, K6
> dispara), com uma porta de rompimento que decidiu 5 vezes em 31 dias e perdeu as 5.
> `inconclusivo` por régua de maturidade (47 avaliáveis < 100; 14 dias distintos < 30). Ligada a
> partir de [[Strategy Backlog]], [[KB-0077-linhas-de-tendencia]],
...
4b. **O CONTRASTE DA INVALIDAÇÃO, pré-registrado em 2026-09-08 (T3.34c), antes de qualquer replay
   ...
   diz se a regra ajudou. O estimando é o do [[EXP-0007-momentum-invalidacao-bracos-INV]] / [[KB-0006-invalidacao-stop-por-atr-ou-saida-por-tempo]], pareado por episódio:
...
para promover ([[KB-0010-overfitting-de-backtest-e-o-preco-de-cada-variante]]).
...
[[KB-0006-invalidacao-stop-por-atr-ou-saida-por-tempo]] noutra estratégia. **A invalidação estrutural desta versão não corta a cauda esquerda
...
**Por que [[KB-0006-invalidacao-stop-por-atr-ou-saida-por-tempo]] e [[EXP-0007-momentum-invalidacao-bracos-INV]] entram aqui, e não são citação de cortesia:** a invalidação
