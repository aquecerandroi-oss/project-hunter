...
- **Observados, executáveis e contribuição marginal são três critérios distintos:** observar depende do ganho de informação e de oportunidades, sujeito a cobertura, latência e recursos; executar depende do ganho líquido marginal da carteira, com simultaneidade e dependência entre mercados, e um mercado pode informar regime sem receber capital (procedência: `.claude/state/astra-review-plantao-20260911-0605.md`, seção "O QUE EU FARIA DIFERENTE").
- **A seleção proposta é comparar universos progressivos escolhidos no treino e avaliados fora dele, admitindo escolher nenhum:** capacidade para certo tamanho apenas em BTC/ETH não demonstra que só esses mercados mereçam observação (procedência: `.claude/state/astra-review-plantao-20260911-0605.md`, seção "O QUE EU FARIA DIFERENTE").
- **A fotografia de 11 segundos só do ask não calibra capacidade operacional:** a continuação D-P22 da D-P19 precisa de entradas e saídas sequenciais, capital ocupado, cortes, custos por tamanho e volume conhecido no momento da decisão, com participação compartilhada entre ordens; usar o volume final do minuto na abertura antecipa informação, e reservar o limite inteiro para cada ordem multiplica a capacidade ficticiamente (procedência: `.claude/state/astra-review-plantao-20260911-0605.md`, seções "RESUMO" e "MUST-FIX"; `.claude/state/plantao/2026-09-11-0625-lane1.md`, item 2).
- **R$ 393,60/dia na D-P19 é cenário com todas as apostas fechando +1 R, não limite matemático de lucro:** as 30 entradas/dia pressupõem cinco posições e horizonte de quatro horas, não duração efetivamente medida, e a conversão de R em dinheiro exige distância do stop, notional, câmbio, giro e custos dependentes do tamanho (procedência: `.claude/state/notes-D-P19.md`, §§9–10; `.claude/state/astra-review-plantao-20260911-0605.md`, "MUST-FIX"; `.claude/state/plantao/2026-09-11-0445-lane3.md`, D-P19).
- **Duração e trajetória devem ficar separadas:** a D-P23 registra mediana de 61 minutos em posição na mãe e mede movimento bruto após a entrada até 240 minutos, inclusive depois de saídas; isso não transforma movimento posterior em lucro capturável nem calibra por si só o giro da D-P19 (procedência: `.claude/state/notes-D-P23.md`, diagnóstico da curva e duração; `.claude/state/plantao/2026-09-11-1030-lane4.md`, seção "Astra").
