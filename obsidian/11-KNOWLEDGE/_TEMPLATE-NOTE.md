...
> Copie para `KB-NNNN-<slug>.md`. Duas chaves do frontmatter não se preenchem no chute:
> **`lido_em`** é a data em que a fonte foi *lida* (não a data em que a nota foi escrita), e
