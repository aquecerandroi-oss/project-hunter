...
> **Arquivada pela Sexta-feira em 2026-09-09 (T3.55a)** a partir do rascunho do agente de literatura
> (`.claude/state/exp-drafts/KB-0080-candlestick-evidencia.md`), escrito entre 00:00 e 00:30 de
> Brasília (03:00–03:30Z). **Nada aqui é medição nossa.** Toda fonte listada foi aberta nesta sessão,
> exceto uma, que está marcada como não aberta em três lugares (frontmatter, §2.7 e §Fontes). Nenhum
> número foi citado de memória. A resposta ao "já estudou sobre o candlestick?" do Everton
> (2026-09-08 23:40) é a §6; a lista para a T3.55b é a §7.
> **Veredito em uma linha (o que a literatura diz, antes de medirmos):** em ações diárias a
> literatura séria diz **não** — o "sim" de Caginalp & Laurent (1998) não sobrevive ao bootstrap de
> Marshall, Young & Rose (2006); em cripto diário, nada nas moedas grandes; a única evidência
> intradiária com correção de *data snooping* (Moser & Brauneis, 2026) **não pôde ser aberta** nesta
> sessão. O par de medição própria é [[KB-0081-candlestick-no-nosso-dado]] (T3.55b).
...
importa: a maioria "sofre de problemas de procedimento: data snooping, seleção ex post das regras
ou das tecnologias de busca, e dificuldade de estimar risco e custos". Sobre a categoria "padrões
...
**Fechamento (T3.55b, o mesmo dia):** H1 e H1' foram testadas e **refutadas** — nenhum IC cruza zero
para o lado certo em 72/144 testes com Holm. Ver [[KB-0081-candlestick-no-nosso-dado]].
...
- **Sinal invertido é sinal de ruído.** Estrela cadente "bullish" (Kuna), marubozu preto com retorno
  ...
  significativo **contra** a direção clássica, a leitura default é artefato, não descoberta. **É
  exatamente o que aconteceu** — ver [[KB-0081-candlestick-no-nosso-dado]].
...
[[KB-0078-o-radar-preve]] · [[KB-0081-candlestick-no-nosso-dado]]
