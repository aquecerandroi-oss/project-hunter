...
| **Dimensionamento e risco (Risk Engine M3/M4)** | KB-0066, KB-0067, KB-0068, KB-0069, KB-0070, KB-0071, KB-0072, KB-0073, KB-0074, KB-0075, **KB-0090** | **oitava rodada feita (2026-09-06)**; **KB-0090 (2026-09-11, D-P19) traduz a meta de R$ 9.000/dia em dinheiro por mercado e hora — o teto do universo executável é 23–57× menor, com o sinal trocado, e a trava dura é vagas × horizonte, não só participação** |
...
| **Plantão de mercado (T3.64) — literatura recente ligada ao resultado do Lab** | KB-0082, **KB-0085**, **KB-0086**, **KB-0091**, **KB-0092** | **iniciado (2026-09-09, run 1, faixa 1); run 5 (2026-09-10, faixa 1) acrescenta a auditoria de liquidez de Aldridge e o estudo negativo de custo de Zeng et al.** — reversão de 15 m em cripto: o sinal está no sinal do candle e no fluxo taker, e sozinho não paga custo; **run 13 (2026-09-12, faixa 1, redirecionada para pump.fun/Meme Radar) abre a KB-0091: seis estudos empíricos, taxas-base de 0,198 % a "< 2 %" que não são comparáveis (janela/denominador), wash atômico ≥ 17 %, e o corrigendo de Kamat como teste de aceite do coletor (D-P25)** |
| **Diagnóstico do nosso próprio resultado** | KB-0008, KB-0076, KB-0079, KB-0083, KB-0087, **KB-0089** | **primeira nota de medição própria em larga escala (2026-09-08, T3.32)** — o custo em R é praticamente toda a perda; **KB-0079 (2026-09-09, T3.53) controla multiplicidade sobre 2 248 células e sobra uma: `momentum v8` perde em `SIDEWAYS`**; **KB-0083 (2026-09-10, D-P9) decompõe a hora de −34 R de 09/09: 9 apostas × 4,3 versões, deriva + impulso de amplitude de 194/200 perpétuos, BTC não caiu**; **KB-0087 (2026-09-10, tarde) fecha as três causas do atraso decisão-menos-barra que a KB-0083 tinha aberto — despacho serial, replay dentro do worker vivo, flush de 1,0 s fixo — com correção medida nas três**; **KB-0089 (2026-09-10 noite/2026-09-11) continua a KB-0087: concorrência parou de ajudar por CPU-bound (GIL), a correção virou sharding por processo + cache de contexto + universo de 90 dias, e `decision_lag_p50_s` fechou em 2,2 s** |
...
| [[KB-0082-reversao-de-15-minutos-o-sinal-e-o-fluxo]] | mean reversion / microestrutura / fluxo taker | Kitron & Wengrowicz, arXiv 2608.21888 (2026-08-22) — HTML aberto duas vezes | preprint com holdout congelado de 6 meses (Binance spot, 183 pares, 15 m); **nenhuma medição própria** | sim — H-P1a/H-P1b (plantão T3.64, run 1): o edge da `mean_reversion` é só a reversão lag-1 de sinal (~1,3 bp bruto) ou a regra acrescenta algo? replay das decisões do EXP-0009 contra controle contrarian pareado, por sinal da barra anterior × tercil de \|taker_imbalance\| |
| [[KB-0083-uma-hora-de-34-r-deriva-e-impulso]] | diagnóstico do resultado / mean_reversion / regime | dado próprio da VPS (D-P9, plantão T3.64) — `signal_outcomes`, `agent_signals`, `candles_1m`, `market_regimes`, 9 SQL somente leitura | replicado sobre uma leitura só (2 dias de série prospectiva) | sim, painel por ora — H-P7 (correlação de barra: R por aposta única vs. pooled) e H-P8 (amplitude do universo em tercis), pré-registradas, não testadas |
...
| [[KB-0089-o-teto-de-cpu-de-um-processo-so]] | diagnóstico do resultado / instrumento / latência | dado próprio da VPS e local (T3.74e, T3.74f, T3.74g, T3.82) — `docker stats`, `pg_stat_activity`, `cProfile`, benchmark sintético e testcontainer | medição própria (VPS) + prova local (bancada/testcontainer), releitura conjunta de `decision_lag_p50_s` pela T3.84 no dia seguinte | não — continuação da KB-0087; fecha a quarta causa (CPU-bound de um processo só) com sharding, cache de contexto e redução do universo de pesquisa; `decision_lag_p50_s` fechou em 2,2 s |
| [[KB-0090-a-meta-em-dinheiro]] | risco / dimensionamento / dinheiro real | dado próprio da VPS (D-P19, plantão T3.64, run 7) — 30 dias de volume por perpétuo, 4 dias SPOT, 3 dias de coorte prospectiva da família `mean_reversion` | medição própria, um snapshot só (3 dias de coorte, 22 apostas nos 16 mercados executáveis) | não — é aritmética de dinheiro sobre limites e giro medidos; a meta de R$ 9.000/dia pede 23–57× o teto de hoje, com o sinal trocado; ordem das alavancas: expectancy → capital → universo |
| [[KB-0091-pump-fun-as-taxas-base-e-seus-denominadores]] | memecoin / pump.fun / taxas-base / instrumento de coleta | Szwajcok et al. (arXiv 2609.10246, CCS'26), Kamat (arXiv 2607.02823 v3 + Zenodo RED-PUMP-2026-v1), Tarantelli-Marino-Naviglio-Lillo (arXiv 2602.14860), Kamat (2607.02795), MELT (2602.13480 v2), Li et al. (2608.20271), Chen et al. (2603.24625 v2), Solidus Labs, Dune — lidos em 2026-09-12 (plantão T3.64, run 13, faixa 1) + nove correções da Astra | um paper aceito (CCS'26) + cinco preprints com dado + relatório de fornecedor + dashboard congelado; **nenhuma medição própria** | sim — D-P25 (janela de visibilidade do coletor: descoberta e acompanhamento separados), H-P29 (trades até a primeira passagem × conclusão; política congelada com `p > (I−F)/(S−F)`), H-P30 (WT1 por intensidade e idade), H-P27 reescrita (vol antecedente do BTC × conclusão 24 h/168 h), painel H-P28 |
| [[KB-0092-o-modelo-pre-registrado-que-morreu-no-holdout]] | memecoin / pump.fun / validação fora da janela / regime | Kamat, RED-PUMP-2026-v1 **v1.5** (Zenodo 10.5281/zenodo.22286914, publicado 06/09/2026; pacote de reprodutibilidade pré-registrado do arXiv 2607.02823) — descrição oficial do depósito lida pela API do Zenodo em 2026-09-12 05:14–05:16 BRT (plantão T4.64, run 4, lane 4) | pré-registro com bootstrap por blocos de dia, sem revisão por pares; pacote não executado aqui | sim — **M-P21**: as features de presença social + log(mcap inicial), ajustadas em 15 dias, têm AUROC ≤ 0,55 para conclusão em 24 h nos 14 dias seguintes; enquanto não refutada, presença social não entra como filtro do funil | pendente | ? — 749 816 mints, 1 597 graduados (0,213 %), AUROC 0,8594 (dev) → 0,4642 [0,4112; 0,5196] (validação), 2 de 9 *stability gates*; v1.5 retira a v1.3 |
| [[KB-0093-dex-paid-e-boost-o-que-custam-e-o-que-medem]] | memecoin / ferramentas / sinais pagos ("Dex paid", "Boost") / DEX Screener / Terminal | páginas do vendedor — `marketplace.dexscreener.com/product/token-info` e `docs.dexscreener.com/boosting` — lidas em 2026-09-12 11:20–11:22 BRT (plantão T4.64, run 10, lane 2) + Terminalpedia (rótulo "Dex paid" do Terminal, terceiro) + endpoint `/orders/v1` apontado pela Astra | descrição do produto pelo vendedor (preço anunciado "a partir de" US$ 299, prazo até 12 h, boosts 12–24 h, Golden Ticker ≥ 500 ativos); **nenhuma medição própria**; preços dos pacotes de Boost não publicados | sim — **M-P30**: sinal pago em três estados (perfil / pedido pago / boost) conhecido até `L = t0 + 30 min` após a migração acrescenta informação a um modelo-base para retenção 24 h e resultado depois de `L`; preditivo, não causal | ok (11:32 BRT; must-fix 3: perfil ≠ pedido pago ≠ boost) | ? — só fato de produto: US$ 299 (de 499), 12–24 h, ≥ 500 ativos, não reembolsável |
| [[KB-0094-pump-fun-upgrade-de-12-09-2026-holder-rewards-e-bonding-curve-v2]] | memecoin / pump.fun / upgrade do programa da curva em 2026-09-12 (holder rewards, fim do cashback, `bonding_curve_v2`, `creator_fee_bps` configurável) | RPC público da Solana (`ProgramData` slot 446 462 760, `getBlockTime` ≈ 12:24:04 BRT, lidos 14:50:49–14:51:48 BRT — plantão T4.64, run 14, lane 2) + `github.com/pump-fun/pump-public-docs` (README, HOLDER_REWARDS_README, COIN_CREATION, PUMP_PROGRAM_README; commit 11:28:42, PR #45 mesclado 12:58:18 BRT) + IDL `main` (T4.14) + Telegram `pump_tech_updates` (silêncio) + `pump.fun/docs/fees` | fato on-chain (slot/hora do bloco do deploy) e de docs/IDL (mecanismo: creator fee 0,30 % para a PDA `holder-rewards`, distribuída pela pump.fun; comprador paga o mesmo; cashback encerrado; `TradeEvent` 32 → 34 campos); falha independente do executor (6074, T4.14) — diagnóstico em aberto; cadência/limiar só por imprensa, **não medidos**; nenhuma moeda holder-rewards observada (REST sem o flag) | sim — **M-D8** (versão do programa como coluna; pré-condição) e **M-P34** (`holder_reward_at_create` × conclusão 24 h e retenção de preço pós-migração; prospectiva) | ok (15:03 BRT; 6 must-fixes aplicados: relógio do bloco ≠ execução ≠ disponibilidade; 6074 sem diagnóstico; 35/70; exposição congelada; dois desfechos; densidade ≠ taxa) | fato on-chain e de docs; imprensa = ? |
| [[KB-0095-pump-fun-rotulos-observados-do-site-da-rest-e-os-limites-on-chain]] | memecoin / pump.fun / rótulos do site (bundle i18n + página SSR) × REST × on-chain — Mayhem (`enabled`/`active`/`paused`/`completed`, "Classic"/"Trigger", `pause_reason`/`complete_reason`) e destinatário das recompensas ("Rewards → creator / holders · {{percent}}% / traders") | `pump.fun/coin/{mint}` ×4 (chaves i18n e texto SSR, 17:44:20–17:49:32 BRT) + `frontend-api-v3` (`/coins` ×4, `/coins/mayhem-mode`, `/coins/{mint}` ×10, `/coins-v2/{mint}/mayhem-state` ×3, 17:43:36–17:44:18 BRT — plantão T4.64, run 17, lane 1) + `docs/PUMPFUN.md` §4.3 (T4.0c, 02:32 BRT) + código do Radar (`mayhem_labels.py`, `meme.py:77`, `mayhem_state.py:50,180`) | valores vistos por campo/fonte/data separados de templates e de inferência; `enabled` antecede o upgrade (02:32 BRT) e o schema o rejeita (loop morreu às 16:4x); `MayhemState` on-chain não expõe estado/razão; "Rewards → holders" nunca visto numa moeda; duração de `enabled` não medida | sim — **M-D11** (rótulo preservado com procedência; duração/espera/atraso separados) e **M-P37** (estado observado na REST em L = criação + 5 min como feature incremental; prospectiva) | ok (18:02 BRT; 7 must-fixes aplicados: normalizador + contratos + CHECKs juntos; conta on-chain sem estado; observações divergentes ≠ transições; L fixo; retenção sem sobreviventes; ganho incremental; denominadores 270/280) | medição própria + templates do site = ? |
| [[KB-0096-pump-fun-is-holder-reward-na-rest-e-o-segundo-deploy-de-15-09-2026]] | memecoin / pump.fun / `is_holder_reward` exposto fora da cadeia (REST `/coins`, boards `hr`, indexer `isHolderReward`) com os primeiros positivos (observado pela primeira vez em 15/09; introdução entre as leituras de 12/09 e 15/09); último deploy observado do programa da curva: slot 447 228 373 ≈ 15/09 07:34 BRT (segunda fronteira conhecida; intermediárias possíveis) | `frontend-api-v3` (`/coins` 70 mais novas: true 7/70; `/coins/mayhem-mode` 0/60; `/coins/{mint}` 0/10), `advanced-indexer` (boards `hr` 7/50 · 5/50 · 10/50; imc `isHolderReward`), rugcheck ×2, DEX Screener (50 graduadas + `orders` ×5), RPC público (`ProgramData` slot 447 228 373, `getBlockTime` ≈ 07:34:32 BRT), páginas ×2 — lidos 16:19:32–16:29:36 BRT (plantão T4.64, run 19, lane 3) | medição própria por endpoint/hora + fato on-chain (slot/hora do bloco); o flag é da REST com `received_at` nosso, não o byte da `BondingCurve`; conteúdo do 2.º upgrade não lido; 7 positivos = 5 clones BARRON com par custom em 3 min de criação; graduadas HR 10/50 com `t10` 21,7 % vs 5,2 % (recorte, descrição); rugcheck/DEX Screener sem vocabulário; "Rewards → holders" ainda não visto | sim — **M-D13** (concordância flag REST × `hr` × imc × página × byte on-chain, com `received_at`, classes true/false/ausente/erro, matriz classe × idade × `program_version`) e **M-P39** (ganho incremental da HR em L = criação + 5 min sobre clone/quote pelo mint/sinal pago, para conclusão em (L, criação + 24 h]; previsão: nenhum) | ok (16:41 BRT; ordem M-D8 → HR via M-D9 ampliada → M-D11; 7 must-fixes aplicados: cronologia, presença ≠ positivos ≠ concordância, desfecho em (L, +24 h], clones como observação exata, descritivo, taxas sem causa, divergências ≠ transições) | medição própria = ? |
| [[KB-0097-pump-fun-rewards-holders-visto-flag-mutavel-e-hr-fora-do-mesmo-slot]] | memecoin / pump.fun / "Rewards → holders" visto pela primeira vez numa moeda (2 páginas, 4 fontes concordantes nos mesmos mints); `is_holder_reward` `true` em moedas graduadas antes do upgrade de 12/09 (fone 26/08, baton 09/09 — flag mutável, conversão posterior); 0/23 graduadas HR no mesmo slot vs 63/103 não-HR (composição, não mecanismo); REST sem campo de fee | `pump.fun/coin/{mint}` ×2 (texto SSR, 17:45:37–40 BRT), `frontend-api-v3` (`/coins` ×4, `/coins/{mint}` ×10, `mayhem-mode`, top-50), `advanced-indexer` (boards ×6, imc ×2) — plantão run 21, lane 1 | medição própria por endpoint/hora com `received_at`; byte on-chain e `creator_fee_bps` não lidos; 2 páginas, 2 moedas antigas, 23 vs 103 numa tarde — descrição | sim — **M-D15** (flag como observação datada por fonte; exposição em L = recebido até L; conversão = classe) e **M-P42** (HR observada até L exclui o caminho mesmo slot; denominador = todas as criações) | ver seção Run 21 em 02-MARKET/Meme/2026-09-15 | medição própria = ? |
| [[KB-0098-quantos-bums-reais-ha-por-dia-e-quanto-tempo-temos]] | memecoin / pump.fun / quantos bums reais há por dia e quanto tempo temos — os 95 picos ≥ 500 SOL de mcap teórico dos 3 dias são todos Mayhem (SOL virtual do agente); com SOL real na curva e sem Mayhem: 6,4 % passam de 30 SOL, mediana 1 min (mesmo slot); a célula lenta (30 SOL após ≥ 3 min) tem ~180 moedas/dia, gradua 5× mais (18,7 %) e o Lab apostou em 14 de 552; **adendo T4.27 (16/09): `mcap_executable_sol` (`0042`) = `min(mcap_sol, real_sol_reserves)` em Mayhem, marca de papel limitada ao SOL real, `exclude_mayhem` ligado por padrão, `meme_reclassify_mayhem.py`; 100/300/1 000 SOL reais não existem numa curva (gradua a 85), os patamares reais são 10/30/60** | 2026-09-16 | medição própria | vivo |
| [[KB-0099-por-que-a-mesa-nao-propoe-e-quanto-custa-cada-criterio]] | memecoin / pump.fun / por que a mesa (`operator/5`) quase não propõe — custo marginal de cada critério do funil e uma porta calibrada para o estágio 1 | 15–16/09/2026 | medição própria (47 017 moedas, 2 dias) | sim — porta calibrada do estágio 1 |
| [[KB-0100-evento-move-moeda-primeira-medida-16-09]] | memecoin / pump.fun / evento → moeda: a primeira medida (8 eventos do plantão de 16/09 contra 18 335 criações do dia) | 16/09/2026 | medição própria, n pequeno, sem replicação | anedótico |
| [[KB-0101-snipers-e-graduacao-a-medida-com-n-grande]] | memecoin / pump.fun / snipers na primeira foto × chegar a 30 SOL reais e encher a curva, com n grande | 12–16/09/2026 | medição própria (64 267 moedas não-Mayhem, 5 dias) | backtest do autor |
| [[KB-0102-snipers-pagam-em-R-ou-so-em-graduacao]] | memecoin / pump.fun / o piso de snipers do KB-0101 paga em R, ou só em graduação? | 12–16/09/2026 | medição própria (315 apostas, 5 dias) | backtest do autor |
| [[KB-0103-clones-fundo-com-preco-forjado-assinatura-e-custo]] | memecoin / pump.fun / a assinatura medida dos clones "fundo-instituição" com preço forjado e o custo de uma regra E2-b | 14–16/09/2026 | medição própria (2 877 graduadas, 3 dias; amostra enviesada) | backtest do autor |
| [[KB-0104-taxas-base-sem-as-nascidas-cheias]] | memecoin / pump.fun / as taxas-base da KB-0098 recalculadas sem as "graduações" que nascem cheias | 12–16/09/2026 | medição própria (52 146 moedas, 3 dias cheios + 2 parciais) | backtest do autor |
| [[KB-0105-e2b-replicacao-12-13-09-e-efeito-em-R]] | memecoin / pump.fun / replicação da E2-b em 12 e 13/09 (fora da amostra do KB-0103) e o efeito dela no R das apostas de papel medidas | 12–13/09/2026 | medição própria (1 828 graduadas, 2 dias, 103 apostas medidas) | replicado |
| [[KB-0106-snipers-e-graduacao-organica]] | memecoin / pump.fun / o KB-0101 refeito com o desfecho limpo — snipers na 1.ª foto × graduação orgânica | 12–16/09/2026 | medição própria (64 879 moedas, 5 dias, 551 graduações orgânicas) | backtest do autor |
| [[KB-0107-celula-lenta-como-porta-da-mesa]] | memecoin / pump.fun / a "célula lenta" (30 SOL reais com ≥ 3 min de vida) como porta para a mesa do estágio 1 — cadência e R simulado | 12–16/09/2026 | medição própria (807 lentas, 5 dias) | backtest do autor |
| [[KB-0108-anatomia-da-morte-depois-da-porta]] | memecoin / pump.fun / anatomia da morte depois da porta — o que acontece nos 5 minutos antes | 15–16/09/2026 | medição própria (879 moedas no dia 15; cobertura de série morre em ~5 min) | backtest do autor |
| [[KB-0109-top10-e-bundle-onde-o-teto-deveria-estar]] | memecoin / pump.fun / onde o teto de `top10_share` (25 %) e o de `bundled_share` (20 %) deveriam estar para o estágio 1 | 12–16/09/2026 | medição própria (344 moedas na porta da mesa, 5 dias) | backtest do autor |
| [[KB-0110-saida-por-drawdown-20-na-serie-de-15s]] | memecoin / pump.fun / a saída por recuo de 20 % do pico na série de 15 s (E20) paga em R nas entradas da porta atual? | 12–16/09/2026 | medição própria (322 entradas, 5 dias) | backtest do autor |
| [[KB-0111-top10-share-maior-que-1-no-retrato-de-risco]] | memecoin / pump.fun / por que `meme_risk_snapshots.top10_share` passa de 1, qual denominador cada fonte usa e qual fonte a admissão real leu | 12–16/09/2026 | medição própria (20 486 retratos, 24 ordens reais) | backtest do autor |
| [[KB-0112-volume-do-minuto-participacao-e-r]] | memecoin / pump.fun / o volume do minuto na entrada separa R? participação como risco de execução × como seleção | 12–16/09/2026 | medição própria (344 entradas, 5 dias) | backtest do autor |
| [[KB-0113-ate-onde-as-series-acompanham-uma-aposta]] | memecoin / pump.fun / até onde as séries (15 s, 1 min, fita de pool) acompanham uma moeda depois da entrada — e quanto do R de hoje é censura | 15/09/2026 | medição própria (132 entradas, 73 apostas fechadas) | backtest do autor |
| [[KB-0114-compradores-unicos-o-piso-e-o-r]] | memecoin / pump.fun / onde colocar o piso de `min_unique_buyers` — cadência e R por piso | 12–16/09/2026 | medição própria (345 entradas, 5 dias) | backtest do autor |
