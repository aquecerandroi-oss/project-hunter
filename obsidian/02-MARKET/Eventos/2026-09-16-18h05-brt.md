...
# Tendências — 2026-09-16, corrida 18h05 BRT (medida 18:00–18:06 BRT; o que mudou desde 17:25)

Quinta corrida do dia (EXP-M8: evento → moeda → mesa). Medição real **18:00–18:06 BRT (21:00–21:06 UTC, `date -u` conferido; o nome
do arquivo é a hora medida)**, ~40 min depois da corrida "18h30" (medida 17:19–17:23 BRT, [[02-MARKET/Eventos/2026-09-16-18h30-brt]])
e da leitura do baha das 17:25 BRT (`.claude/state/plantao-meme/baha-2026-09-16-1725.md`). Só APIs públicas (DexScreener boosts/perfis/53 pares
em 6 lotes de ≤ 10/85 buscas, pump.fun top mcap/ao vivo/150 mais novas/12 fichas, CoinGecko trending, RSS das 4 redações). **baha.com e X não lidos** —
todo post/anúncio é `reported`/`rumor`. SOL = US$ 98,25. Régua de forja: [[11-KNOWLEDGE/KB-0103-clones-fundo-com-preco-forjado-assinatura-e-custo]]
(encheu ≤ 60 s ou maior comprador ≥ 35 %); desfecho pela cadeia: [[11-KNOWLEDGE/KB-0115-volta-ao-piso-e-real-ou-artefato]]; método:
[[11-KNOWLEDGE/KB-0100-evento-move-moeda-primeira-medida-16-09]].

**Resumo em uma linha:** as três gerações `X*` morreram (`XDOGE` −99,4 %, `XCEO` −98,5 %) enquanto `PAID`/`ELON` viraram para cima; na narrativa
"taxa para streamer" o vencedor trocou — `DONO` ×13 (1,79 M/h), `HYPED` −88 % (o M-P54 acertou uma e errou a outra → M-P55); `ILY` teve 2.ª onda com
liquidez e virou molde ("there is no …", `ZINU`); o `LUV` do top-8 anterior é ação tokenizada (Southwest/Backpack), não meme; **novo**: cluster
`ISHOWSPEED` (16 pares, 3 com liquidez, 150–530 k/h); `MAYDAY`/avião e as 2 notícias novas (Clarity lame-duck, agentes rebeldes da OpenAI) não viraram moeda.
...
## Ligações
[[02-MARKET/Eventos/2026-09-16-18h30-brt]] (corrida anterior, medida 17:19–17:23 BRT) · [[03-TRADING/Meme/Candidatas/2026-09-16-17h56-brt]] (§4 vigilância 0 de 6; §5 TOKTIP) ·
[[11-KNOWLEDGE/KB-0100-evento-move-moeda-primeira-medida-16-09]] · [[11-KNOWLEDGE/KB-0103-clones-fundo-com-preco-forjado-assinatura-e-custo]] ·
[[11-KNOWLEDGE/KB-0115-volta-ao-piso-e-real-ou-artefato]] · [[00-INBOX/Hipoteses-do-plantao]] (M-P55) ·
`.claude/state/plantao-meme/tendencias-2026-09-16-18h05-brt.md` (versão de estado) · `.claude/state/plantao-meme/baha-2026-09-16-1725.md` (baha 17:25 BRT) ·
brutos em `%LOCALAPPDATA%\Temp\claude\p18\` (não versionados)
