...
params_hash: 6b6168718cf2
activated_at: "2026-09-08T22:38:49.950926+00:00"
deprecated_at: ""
derived_from: "[[Estrategias/mean_reversion-v2|mean_reversion-v2]]"
cohorts: ["replay:264b227f-5bc0-4930-8c5b-2e883c0a858e"]
exp: ["[[EXP-0018-stop-largo]]"]
updated: 2026-09-08
---
# mean_reversion v7 (active)
...
**Changelog congelado:** `variante de v2 | derived_from=v2 | overrides=stop_atr=2,target2_atr=5,target_atr=3 | params_hash=6b6168718cf2` (T3.47).

## Coortes e sinais

| Coorte | Sinais (`agent_signals`) |
|---|---|
| `replay:264b227f-5bc0-4930-8c5b-2e883c0a858e` | 14 (`EXP-0018`, retrospectiva B2) |
...
**Veredito mais recente:** **manter em pesquisa, com ressalva** — só **32 %** da economia de pedágio de custo sobrevive (líquida +0,3450 R, PF 4,761); 28,6 % das decisões fora da banda de stop do `paper_v1`; K1 (14 decisões) impede conclusão.
