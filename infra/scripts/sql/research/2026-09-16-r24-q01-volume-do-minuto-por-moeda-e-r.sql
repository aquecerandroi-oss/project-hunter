-- KB-0112 Q01 — uma linha por moeda: volume/fluxo/compradores do MINUTO na barra de
-- ENTRADA e o R simulado. Reuso literal do r19-q01 (KB-0109); a unica mudanca e o que
...
SELECT :'dia' AS dia, e.mint, e.t_in, e.snipers, e.holders,
       ...
       round(e.vol_60s_foto::numeric, 4) AS vol_60s_foto,
