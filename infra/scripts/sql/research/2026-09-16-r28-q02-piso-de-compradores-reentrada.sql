-- KB-0114 Q02 — o piso de compradores aplicado NA ESCOLHA DA BARRA DE ENTRADA (:piso):
...
-- mesma entrada (holders >= 20, unique_buyers >= :piso, sells/buys <= 0,6), mesma saida
...
-- Uso: psql -v dia=2026-09-15 -v piso=25 -v ew=5 -v hz=30 -At -f este-arquivo.sql
