 ...
 * has no `proposals.py`. The real milestone that adds it is named (M3: the
 * admission service and the shadow -> admission bridge), never a task id
 * (DESIGN-5, "sem backstage na copy"), and never claimed as an operational
 * absence this screen could otherwise explain.
 */
  ...
  return (
    <div className="rounded-md border border-dashed border-border bg-bg-elevated p-4">
      ...
      <p className="mt-1 text-sm text-fg-muted">
        Ainda sem propostas — o serviço de admissão, que registra os checks e o limitante vencedor de cada decisão, chega no M3.
      </p>
