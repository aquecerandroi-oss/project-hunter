 ...
 * `fg-muted` title, 24px tabular value, semantic variation with an arrow,
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <section className="rounded-lg border border-border bg-bg-elevated p-4 transition-colors hover:border-border-strong">
        ...
        <p className="num mt-1 text-2xl font-semibold text-fg">$12.480,50</p>
      ...
      <section className="rounded-lg border border-border bg-bg-elevated p-4 transition-colors hover:border-border-strong">
        ...
        <p className="num mt-1 text-2xl font-semibold text-fg">$3.900,00</p>
